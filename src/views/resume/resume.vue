...
<script>
    import Con1 from "./compoments/compon1";
    import Con2 from "./compoments/compon2";
    // import About from "../about/About";


    import Con3 from "./compoments/compon3";
    import Con4 from "./compoments/compon4";
    export default {
        components: {
            Con1,
            Con2,
